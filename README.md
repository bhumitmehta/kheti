...
> The other problem we are trying to solve is the problem of overproduction . Overproduction is one of the major reason for global food  wastage . because of overproduction of certain crops of in the region this increses the supply in that region and decrease the price of the crops .
>the other thing we are implementing is tech-blog where farmer can query or try to find solution for thier problem with the help of blogs posted on the application 
## Features
